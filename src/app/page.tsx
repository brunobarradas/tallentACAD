    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        <p className="mt-8 text-gray-500 max-w-md">
          A plataforma de formação online para empresas que querem crescer.
        </p>
        <div className="mt-10 flex gap-4 justify-center">
          ...
          <a
            href="#"
            className="px-6 py-3 border border-[#1e3a5f] text-[#1e3a5f] rounded-lg font-medium hover:bg-gray-100 transition"
          >
            Saber mais
          </a>
        </div>
